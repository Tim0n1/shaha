...
.. code-block:: console
    ...
    $ python -m intellichess.recognition.recognition --help
...
from intellichess.corner_detection import find_corners, resize_image
from intellichess.occupancy_classifier import create_dataset as create_occupancy_dataset
from intellichess.piece_classifier import create_dataset as create_piece_dataset
from intellichess.core import device, DEVICE
from intellichess.core.dataset import build_transforms, Datasets
from intellichess.core.dataset import name_to_piece
...
def main(classifiers_folder: Path = URI("models://"), setup: callable = lambda: None):
    ...
    parser.add_argument("--file", help="indicates that the file argument is file and not list of pixel values", action="store_true",dest="type")
    parser.add_argument("--array", help='indicates that the file argument is array and not file', action="store_false", dest="type")
...
if __name__ == "__main__":
    from intellichess.occupancy_classifier.download_model import ensure_model as ensure_occupancy_classifier
    from intellichess.piece_classifier.download_model import ensure_model as ensure_piece_classifier
