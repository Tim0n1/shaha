...
.. code-block:: console
    ...
    $ python -m intellichess.corner_detection.detect_corners --help
...
from intellichess.core.coordinates import from_homogenous_coordinates, to_homogenous_coordinates
from intellichess.core.exceptions import ChessboardNotLocatedException
