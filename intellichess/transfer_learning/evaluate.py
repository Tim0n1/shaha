...
.. code-block:: console
    ...
    $ python -m intellichess.transfer_learning.evaluate --help
...
from intellichess.recognition.recognition import TimedChessRecognizer
from intellichess.recognition.evaluate import evaluate
from intellichess.core import sort_corner_points
from intellichess.core.dataset import Datasets
from intellichess.core.exceptions import RecognitionException
