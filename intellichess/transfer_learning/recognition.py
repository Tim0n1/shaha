...
.. code-block:: console
    ...
    $ python -m intellichess.transfer_learning.recognition --help
...
from intellichess.recognition.recognition import main

if __name__ == "__main__":
    from intellichess.transfer_learning.download_models import ensure_models
