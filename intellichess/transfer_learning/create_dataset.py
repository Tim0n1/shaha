...
.. code-block:: console
    ...
    $ python -m intellichess.transfer_learning.create_dataset --help
...
from intellichess.piece_classifier import create_dataset as create_pieces_dataset
from intellichess.core.dataset import Datasets
