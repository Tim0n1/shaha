...
from intellichess.core.registry import Registry
from intellichess.core.models import MODELS_REGISTRY

NUM_CLASSES = 2

#: Registry of occupancy classifiers (registered in the global :attr:`intellichess.core.models.MODELS_REGISTRY` under the key ``OCCUPANCY_CLASSIFIER``)
